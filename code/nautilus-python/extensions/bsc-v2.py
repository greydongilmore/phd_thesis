...
FileManagerPython::datetime_original_column',
            ...
            FileManager.Column(name='\
FileManagerPython::datetime_creation_column',
                               attribute='datetime_creation',
                               label=_('Creation date'),
                               description=_('Photo creation date')),
            FileManager.Column(name='\
...
FileManagerPython::pages_column',
    ...
    def update_file_info(self, file):
        ...
        file.add_string_attribute('datetime_creation', '')
        ...
        if file.is_mime_type('video/x-msvideo') or\
            ...
            try:
                file.add_string_attribute(
                    'datetime_creation',
                    datetime.datetime.utcfromtimestamp(os.stat(filename).st_mtime).strftime('%d %b %Y')
                    )
            except Exception:
                file.add_string_attribute('datetime_creation', '')
